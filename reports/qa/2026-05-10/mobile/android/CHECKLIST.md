# Mobile onboarding screenshot checklist — android
...
mcp__computer-use__screenshot  →  save bytes to
  /Users/shawwalters/eliza-workspace/milady/reports/qa/2026-05-10/mobile/android/M1-cold-launch.png
```

When done, run:

```
node scripts/qa/mobile-screenshot-walkthrough.mjs --finalize --surface android
```
