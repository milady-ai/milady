                ...
                {envVars.map((ev, i) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="h-10 w-10 rounded-xl border border-transparent text-text-subtle hover:border-red-400/20 hover:bg-status-stopped/10 hover:text-status-stopped"
                    >
                      ×
                    </Button>
                  </div>
