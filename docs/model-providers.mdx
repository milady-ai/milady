...
| [OpenRouter](https://openrouter.ai) | `@elizaos/plugin-openrouter` | `OPENROUTER_API_KEY` | No | 100+ models behind one API key. Auto-installed on first use. |
| [Groq](https://groq.com) | `@elizaos/plugin-groq` | `GROQ_API_KEY` | No | Ultra-fast inference (LPU). Auto-installed on first use. |
