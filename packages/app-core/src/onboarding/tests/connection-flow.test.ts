...
describe("connection-flow", () => {
  ...
  describe("isProviderConfirmDisabled", () => {
    ...
    it("elizacloud: disabled when not connected, no persisted key, and no API key field", () => {
      expect(
        isProviderConfirmDisabled({
          ...defaults,
          provider: "elizacloud",
    ...
    it("elizacloud: enabled when OAuth connected", () => {
      expect(
        isProviderConfirmDisabled({
          ...defaults,
          provider: "elizacloud",
    ...
    it("elizacloud: enabled when server reports persisted key (connected flag may lag)", () => {
      expect(
        isProviderConfirmDisabled({
          ...defaults,
          provider: "elizacloud",
    ...
    it("elizacloud: enabled when API key field has text", () => {
      expect(
        isProviderConfirmDisabled({
          ...defaults,
          provider: "elizacloud",
