...
`,e.jsxs(s.p,{children:["Pick an absolute path on your machine, e.g. ",e.jsx(s.code,{children:"~/.local/state/milady/whatsapp-auth/"}),". Milady will store the encrypted session here."]}),`
