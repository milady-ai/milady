...
`,e.jsxs(n.p,{children:["You install ",e.jsx(n.a,{href:"https://ollama.com",children:"Ollama"}),", download a model file (a few GB), and Milady talks to Ollama running on your machine. Nothing ever leaves your computer."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Pros:"})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Do you have a capable GPU and care a lot about privacy?"})," → Local (Ollama). Install Ollama, pick a model like ",e.jsx(n.code,{children:"llama3.3"})," or ",e.jsx(n.code,{children:"gemma3:4b"}),", plug it into Milady."]}),`
