...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Your private key leaks."})," If your machine is compromised or your ",e.jsx(n.code,{children:"~/.local/state/milady/"})," directory gets exfiltrated, anyone with the key can drain the wallet. This is why you use a fresh wallet with minimal funds."]}),`
