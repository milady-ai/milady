...
`]}),`
`,e.jsxs(n.p,{children:["Save the cookies as JSON at a path you'll reference, e.g. ",e.jsx(n.code,{children:"~/.local/state/milady/zalouser-cookies.json"}),"."]}),`
