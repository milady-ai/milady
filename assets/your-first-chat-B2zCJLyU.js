import{u as i,j as e}from"./index-CY5_lJb8.js";function s(t){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...i(),...t.components},{Callout:o}=n;return o||r("Callout"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"your-first-chat",children:e.jsx(n.a,{className:"anchor",href:"#your-first-chat",children:"Your first chat"})}),`
...
`,e.jsx(o,{kind:"tip",children:e.jsx(n.p,{children:"Headphones are strongly recommended the first time you hear it. The default voices are good, and hearing an AI talk back through laptop speakers in a quiet room is a weirder experience than you might expect."})}),`
...
`,e.jsxs(n.p,{children:["Right on your machine, in a local database under ",e.jsx(n.code,{children:"~/.local/state/milady/"})," (Windows: ",e.jsx(n.code,{children:"%USERPROFILE%\\.local\\state\\milady\\"}),")."]}),`
...
`,e.jsxs(n.li,{children:["Backups and migrations are your responsibility. If you want to move Milady to a new machine, copy the ",e.jsx(n.code,{children:"~/.local/state/milady/"})," directory and you're done."]}),`
`]}),`
...
`,e.jsx(o,{kind:"note",children:e.jsx(n.p,{children:"Each conversation is independent. Your agent remembers things you told it in one conversation, but it won't automatically surface them in a new conversation unless you've set up memory / knowledge (we'll cover that in the Intermediate tier)."})}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"/docs/beginner/picking-a-provider",children:"Picking a provider"})," — a deeper look at the provider choice you made during onboarding, and how to pick something different if it's not working out."]})]})}function h(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}function r(t,n){throw new Error("Expected component `"+t+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default};
