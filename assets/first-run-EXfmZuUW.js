import{u as s,j as e}from"./index-DJyVX2Jm.js";function i(r){const n={a:"a",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...r.components},{Callout:t}=n;return t||a("Callout"),e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"your-first-launch",children:e.jsx(n.a,{className:"anchor",href:"#your-first-launch",children:"Your first launch"})}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"A local model"})," running via ",e.jsx(n.a,{href:"https://ollama.com",children:"Ollama"}),". No key required; it runs entirely on your machine."]}),`
