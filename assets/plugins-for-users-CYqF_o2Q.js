...
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Uninstall"})," (Settings → Plugins → Installed → Uninstall button): plugin is removed from disk. Its credentials might still be stored in ",e.jsx(n.code,{children:"~/.local/state/milady/milady.json"})," — Milady asks whether to wipe them when you uninstall."]}),`
