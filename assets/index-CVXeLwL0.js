import{u as r,j as e}from"./index-DKRWhpyJ.js";function s(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"for-developers",children:e.jsx(n.a,{className:"anchor",href:"#for-developers",children:"For developers"})}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Architecture guide"})," — how Milady wraps elizaOS, how the Bun CLI talks to the Electrobun desktop shell, and how the feature components in ",e.jsx(n.code,{children:"@elizaos/app-core"})," get consumed by the Vite shell at ",e.jsx(n.code,{children:"apps/web/"}),"."]}),`
