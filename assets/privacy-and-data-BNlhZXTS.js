...
`,e.jsxs(n.p,{children:["Everything below lives in ",e.jsx(n.code,{children:"~/.local/state/milady/"})," (macOS/Linux) or ",e.jsx(n.code,{children:"%USERPROFILE%\\.local\\state\\milady\\"})," (Windows):"]}),`
...
`,e.jsx(r,{kind:"tip",children:e.jsxs(n.p,{children:["If you want to know what's in your Milady install without opening the app, open ",e.jsx("code",{children:"~/.local/state/milady/"})," in a file browser. The directory structure is human-readable. The only thing you can't inspect directly is the SQLite conversation database (use a SQLite browser if you really want to)."]})}),`
...
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"What you can do about it:"})," use a local provider. Ollama + llama3.3 is a fully local setup where chat never leaves your machine. Tradeoff: slower and less capable than cloud models."]}),`
...
`,e.jsxs(n.li,{children:["Your ",e.jsx(n.code,{children:"~/.local/state/milady/"})," directory as a whole."]}),`
