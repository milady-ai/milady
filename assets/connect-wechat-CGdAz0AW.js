...
`,e.jsxs(s.p,{children:["Open ",e.jsx(s.code,{children:"~/.local/state/milady/milady.json"})," and add a ",e.jsx(s.code,{children:"connectors.wechat"})," block:"]}),`
