...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Loading a custom VRM"}),' — click "Upload custom" and pick a ',e.jsx(n.code,{children:".vrm"})," file. It gets copied into your ",e.jsx(n.code,{children:"~/.local/state/milady/"})," directory and persists across launches."]}),`
