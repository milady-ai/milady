...
`,e.jsxs(s.p,{children:["The MCP connector is configured through ",e.jsx(s.code,{children:"~/.local/state/milady/milady.json"})," because MCP configuration is structurally richer than a flat list of env vars. Add an ",e.jsx(s.code,{children:"mcp"})," block:"]}),`
