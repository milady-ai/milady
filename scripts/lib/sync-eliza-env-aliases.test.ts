...
describe("syncElizaEnvAliases", () => {
  ...
  const touchedKeys = [
    ...
    "MILADY_DESKTOP_RUNTIME_MODE",
    "ELIZA_DESKTOP_RUNTIME_MODE",
    "MILADY_DESKTOP_CLOUD_ONLY",
    "ELIZA_DESKTOP_CLOUD_ONLY",
    "MILADY_DESKTOP_CLOUD_AGENT_BASE",
    "ELIZA_DESKTOP_CLOUD_AGENT_BASE",
    "MILADY_DESKTOP_PILL",
    "ELIZA_DESKTOP_PILL",
    "MILADY_DESKTOP_DISABLE_PILL",
    "ELIZA_DESKTOP_DISABLE_PILL",
    "MILADY_DESKTOP_VITE_WATCH",
    "ELIZA_DESKTOP_VITE_WATCH",
    "MILADY_DESKTOP_VITE_BUILD_WATCH",
    "ELIZA_DESKTOP_VITE_BUILD_WATCH",
    "MILADY_RENDERER_URL",
    "ELIZA_RENDERER_URL",
  ...
  it("maps Milady desktop API base env into the elizaOS runtime keys", () => {
    ...
    process.env.MILADY_DESKTOP_RUNTIME_MODE = "cloud";
    process.env.MILADY_DESKTOP_CLOUD_ONLY = "1";
    process.env.MILADY_DESKTOP_CLOUD_AGENT_BASE = "https://agent.example.com";
    process.env.MILADY_DESKTOP_PILL = "0";
    process.env.MILADY_DESKTOP_DISABLE_PILL = "1";
    ...
    expect(process.env.ELIZA_DESKTOP_RUNTIME_MODE).toBe("cloud");
    expect(process.env.ELIZA_DESKTOP_CLOUD_ONLY).toBe("1");
    expect(process.env.ELIZA_DESKTOP_CLOUD_AGENT_BASE).toBe(
      "https://agent.example.com",
    );
    expect(process.env.ELIZA_DESKTOP_PILL).toBe("0");
    expect(process.env.ELIZA_DESKTOP_DISABLE_PILL).toBe("1");
    expect(process.env.ELIZA_DESKTOP_VITE_WATCH).toBe("1");
    expect(process.env.ELIZA_DESKTOP_VITE_BUILD_WATCH).toBe("1");
  ...
  it.each([
    ...
    ["MILADY_DESKTOP_RUNTIME_MODE", "ELIZA_DESKTOP_RUNTIME_MODE"],
    ["MILADY_DESKTOP_CLOUD_ONLY", "ELIZA_DESKTOP_CLOUD_ONLY"],
    ["MILADY_DESKTOP_CLOUD_AGENT_BASE", "ELIZA_DESKTOP_CLOUD_AGENT_BASE"],
    ["MILADY_DESKTOP_PILL", "ELIZA_DESKTOP_PILL"],
    ["MILADY_DESKTOP_DISABLE_PILL", "ELIZA_DESKTOP_DISABLE_PILL"],
    ["MILADY_DESKTOP_VITE_WATCH", "ELIZA_DESKTOP_VITE_WATCH"],
    ["MILADY_DESKTOP_VITE_BUILD_WATCH", "ELIZA_DESKTOP_VITE_BUILD_WATCH"],
