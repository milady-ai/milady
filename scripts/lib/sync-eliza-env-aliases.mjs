...
function buildEnvPairs(brandedPrefix) {
  ...
  return [
    ...
    [prefixed("DESKTOP_RUNTIME_MODE"), "ELIZA_DESKTOP_RUNTIME_MODE"],
    [prefixed("DESKTOP_CLOUD_ONLY"), "ELIZA_DESKTOP_CLOUD_ONLY"],
    [prefixed("DESKTOP_CLOUD_AGENT_BASE"), "ELIZA_DESKTOP_CLOUD_AGENT_BASE"],
    [prefixed("DESKTOP_PILL"), "ELIZA_DESKTOP_PILL"],
    [prefixed("DESKTOP_DISABLE_PILL"), "ELIZA_DESKTOP_DISABLE_PILL"],
    [prefixed("DESKTOP_VITE_WATCH"), "ELIZA_DESKTOP_VITE_WATCH"],
    [prefixed("DESKTOP_VITE_BUILD_WATCH"), "ELIZA_DESKTOP_VITE_BUILD_WATCH"],
