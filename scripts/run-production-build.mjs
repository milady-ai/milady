 ...
 * 0. @elizaos/shared i18n codegen (validation-keyword-data.ts; gitignored in eliza)
...
const generateKeywordsScript = path.join(
  rootDir,
  "eliza",
  "packages",
  "shared",
...
await run(node, [generateKeywordsScript, "--target", "ts"], rootDir);
